...
#pragma mark - 切换视图changeCollectionView
- (void)createChangeCollectionView {
    UICollectionViewFlowLayout *flowLayout = [[UICollectionViewFlowLayout alloc]init];
    flowLayout.itemSize = CGSizeMake(WIDTHSCREEN, HEIGHTSCREEN - _topCollectionView.bounds.origin.y - _topCollectionView.bounds.size.height);
    flowLayout.minimumInteritemSpacing = 0;
    flowLayout.minimumLineSpacing = 0;
    flowLayout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    flowLayout.sectionInset = UIEdgeInsetsMake(0, 0, 0, 0);
    self.changeCollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, _topCollectionView.bounds.origin.y + _topCollectionView.bounds.size.height, WIDTHSCREEN, HEIGHTSCREEN - _topCollectionView.bounds.origin.y - _topCollectionView.bounds.size.height) collectionViewLayout:flowLayout];
