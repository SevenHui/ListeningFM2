...
- (void)localCityButtonAction:(UIButton *)localCityButton {
    NSLog(@"+++++++听大连");
    XQ_LocalCityMoreViewController *localCityMoreVC = [[XQ_LocalCityMoreViewController alloc] init];
    
    localCityMoreVC.strTitle = _strLocalCity;
    
    [[self naviController] pushViewController:localCityMoreVC animated:YES];
...
- (void)getUpData {
    ...
    [_arrLocalCity removeAllObjects];
